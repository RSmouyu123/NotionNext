...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'RS型某鱼', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '两字功名一剑歌', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.rsmouyu.icu', // 网站地址
  ...
  PWA_ICON_512_MASKABLE: process.env.NEXT_PUBLIC_PWA_ICON_512_MASKABLE || '/Blogicon_512.png', // 可选：覆盖 manifest 512x512 maskable 图标；资源应留有足够安全边距
